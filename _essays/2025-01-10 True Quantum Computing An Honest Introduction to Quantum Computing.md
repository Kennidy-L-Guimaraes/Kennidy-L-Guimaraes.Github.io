...
references:
  nureg: 
    text: "NUREG-1717. Systematic Radiological Assessment of Exemptions for Source and Byproduct Materials. U.S. Nuclear Regulatory Commission."
    url: "https://www.orau.org/health-physics-museum/collection/consumer/glass/vaseline-uranium-glass.html"

  oliveira: 
    text: "Oliveira, Maria Luiza de. (2018). Deviations from concepts of quantum theory through the bricolage of non-scientists. Master's thesis — State University of Campinas."
    url: "https://hdl.handle.net/20.500.12733/1634823"

  livescience: 
    text: "LiveScience. Quantum mechanics: Definitions, axioms, and key concepts of quantum physics. "
    url: "https://www.livescience.com/33816-quantum-mechanics-explanation.html"
  
  stanford:
    text: "Stanford Encyclopedia of Philosophy. The Uncertainty Principle. "
    url: "https://plato.stanford.edu/entries/qt-uncertainty/"

  letstalk:
    text: "Let's Talk Science. Introduction to the Atom. "       
    url: "https://letstalkscience.ca/educational-resources/backgrounders/introduction-atom"

  brilliant: 
    text: "Brilliant. Quantum Entanglement."
    url: "https://brilliant.org/wiki/quantum-entanglement/"

  techmonitor: 
    text: "TechMonitor. What Is A Bit? "
    url: "https://www.techmonitor.ai/what-is/what-is-a-bit/"

  waterloo: 
    text:  "Institute for Quantum Computing, University of Waterloo. Qubits. "         
    url: "https://uwaterloo.ca/institute-for-quantum-computing/resources/quantum-101/qist/qubits"

  liuqiyu:
    text: "Liu, Qiyu. (2023). Comparisons of Conventional Computing and Quantum Computing Approaches. Highlights in Science, Engineering and Technology. 38. 502–507. "
    url: "https://www.researchgate.net/publication/369465303"

  odeh: 
    text: "Odeh, Ammar & Abdelfattah, Eman. (2016). Quantum sort algorithm based on entanglement qubits. " 
    url: "https://www.researchgate.net/profile/Ammar-Odeh/publication/304188668"

  doe:
    text: "U.S. Department of Energy. DOE Explains... Bosons and Fermions. "         
    url: "https://www.energy.gov/science/doe-explainsbosons-and-fermions"

  iee: 
    text: "Singh, Rohit & Bodile, Roshan M. A Quick Guide to Quantum Communication. IEEE. "        
    url: "https://arxiv.org/html/2402.15707v1"

  csasets:
    text:  "Cloud Security Alliance. CSA Sets Countdown Clock to Quantum. 2022. "         # [13]
    url: "https://cloudsecurityalliance.org/press-releases/2022/03/09/cloud-security-alliance-sets-countdown-clock-to-quantum"
related:
...
As mentioned earlier, atoms and particles are found in everything around us — and this is not limited to the present; past events do not constrain quantum nature. In 1935, Einstein, Boris Podolsky, and Nathan Rosen proposed the viability of maintaining a correlated configuration for two particles {% include ref.html id="brilliant" %}. These "twin particles" maintained correlated properties: when one particle changed, the other would follow suit.
...
All particles that exist in the universe can be divided into two great families: **Bosons** and **Fermions**. The difference between them lies in their spin {% include ref.html id="doe" %}.
...
Understand it from this angle: if a classical computer, using Grover's algorithm, takes $O(n)$ to search an unsorted list, a quantum computer using the same algorithm takes approximately $O(\sqrt{n})$ — because, in quantum superposition, all possible states can be available simultaneously {% include ref.html id="odeh" %}:
...
The Cloud Security Alliance (CSA) estimates that by 2030, quantum computers may be capable of breaking current cryptographic algorithms {% include ref.html id="csasets" %}. Projections indicate that around 200,000 qubits would be needed to break RSA-2048 in 24 hours — a scenario far from the current capacity of hundreds to a few thousand physical qubits.
