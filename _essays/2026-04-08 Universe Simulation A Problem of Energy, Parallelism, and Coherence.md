...
Well, such an error would be something of magnitude $< 0.0000001%$ of the total projection, admissible even in complex systems.
...
_“A dumb system for such intelligent beings.”_
...
$$E = 7.35 \times 10^{22} \cdot (299{,}792{,}458)^2$$
...
It is amusing to compare this with computational graphics.

When designing a game, we do not simulate: Every molecule, Every atom, Every electron Of an unseen grain of sand.
But suppose we did.

For the agent inside that system, it would be indistinguishable from reality.
Thus: If a simulation is indistinguishable from reality, it ceases to be a simulation.

We may invert the question:
Are we inside a simulation? Or are hypothetical simulators inside what is, to them, equally indistinguishable reality?

“If a simulation is indistinguishable from reality, then calling it a simulation has already lost its meaning.”
</div>